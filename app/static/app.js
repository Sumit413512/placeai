(() => {
  ...
  function platformRegistrationDetailHtml(d) {
    ...
    const activityRows=[
      ['Access type',a.access_type],['Individual access status',a.individual_access_status],['Trial ends',a.trial_ends_at?fmtDateTime(a.trial_ends_at):null],['Paid access until',a.paid_access_until?fmtDateTime(a.paid_access_until):null],
