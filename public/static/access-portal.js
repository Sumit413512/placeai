(() => {
  ...
  function updateLoginRole(roleKey) {
    ...
    const summaryLabel = summary?.querySelector('[data-access-summary-label]');
    const summaryShort = summary?.querySelector('[data-access-summary-short]');
